...
while iter <= maxiter
    ...
    coeft1 = [(1-alpha1)*coeft1; alpha1*tau1 ];
    [coeft1]=grad_proj_pari2(At1,y-x2,tau1);
    x1=At1*coeft1;
    history1 = [history1 Phi*next_atom];
...
%     [~, ind_rem] = min(-coeft1.*(At1'*gradfb)+0.5*sum(history1.^2,1)'.*coeft1.^2);
...
%     coeft2 = [(1-alpha2)*coeft2; tau2*alpha2];
    At2=[At2, next_atom];
    
    [coeft2]=grad_proj_pari2(At2,y-x1,tau2);
    x2=At2*coeft2;
