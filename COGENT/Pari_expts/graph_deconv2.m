...
selfun2 = @(gradf) selfun_grid(gradf);
[x1,x2,At1, At2 iter, obj, time, back_count]=CoGEnT_Demix2(y, Phi, tau1, tau2, Ainit1, Ainit2, selfun1, selfun2,size(A1),'maxiter',400);
