...
//! \page page_Aoper_formUVt Evaluating the Constraints (Aoper_formUVt in dataoper.c)
//! 
//! This page describes one of the main computational routines in SDPLR,
//! namely to apply the constraint operator \f$ {\cal A} \f$ to matrices
...
ptrdiff_t Aoper_formUVt(problemdata* data, double* passedUVt, double* U, double* V, ptrdiff_t same)
{
  ...
  /* ptrdiff_t ctr, blksz, rank; */
  ptrdiff_t blksz, rank;
  /* double tempval; */

  ptrdiff_t j;
  ptrdiff_t *colptr, *rowind;
  double *UVt;
...
// ptrdiff_t sparsesymmmat_timesmat(sparsesymmmat *S, double* vec, double* result, ptrdiff_t n, ptrdiff_t m)
// {
//   ptrdiff_t k, r, c, nnz;
//   double ent;
