...
// ptrdiff_t generate_params_info(ptrdiff_t);
// ptrdiff_t getparams_maxlinelength(FILE*);
// ptrdiff_t getparams_getline(FILE*, char*, ptrdiff_t);
// ptrdiff_t getparams_tolower(char*, ptrdiff_t);
// ptrdiff_t getparams_isnumber(char*);
...
ptrdiff_t*    typebd)
{
  ptrdiff_t i, buffsz, ret, numparams=NUMPARAMS;
  ptrdiff_t assigned[NUMPARAMS];
  ...
  *typebd       = TYPEBD;            values[13] = (double)TYPEBD;
  ...
  if(fid == NULL) {
    ...
    *inputtype    = (ptrdiff_t)values[0];
    *rho_f        =      values[1];
    *rho_c        =      values[2];
    *sigmafac     =      values[3];
    *rankreduce   = (ptrdiff_t)values[4];
    *timelim      = (ptrdiff_t)values[5];
    *printlevel   = (ptrdiff_t)values[6];
    *dthresh_dim  = (ptrdiff_t)values[7];
    *dthresh_dens =      values[8];
    *numbfgsvecs  = (ptrdiff_t)values[9];
    *rankredtol   =      values[10];
    *gaptol       =      values[11];
    *checkbd      = (ptrdiff_t)values[12];
    *typebd       = (ptrdiff_t)values[13];
