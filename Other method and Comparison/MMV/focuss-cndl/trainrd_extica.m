function [rmse, A, x, diversity, x100norm] = trainrd_extica(y, x, params, Ainit, targetdiv, Aorig, xorig)
% traidrd_extica - Calls the ExtICA algorithm (ext_ica.m)  See Lee:1999c
%
...
% Call the Extended ICA learning algorithm 
